...
pub fn map(input: String) -> String {
    ...
    confusables.insert('l', vec!['\u{007C}','\u{2223}','\u{0031}','\u{0661}','\u{06F1}','\u{10320}','\u{1E8C7}','\u{1D7CF}','\u{1D7D9}','\u{1D7F7}','\u{0049}','\u{2160}','\u{2111}','\u{1D408}','\u{1D470}','\u{1D4D8}','\u{1D540}','\u{1D574}','\u{1D5A8}','\u{1D5DC}','\u{1D610}','\u{1D644}','\u{1D678}','\u{0196}','\u{217C}','\u{1D425}','\u{1D459}','\u{1D48D}','\u{1D4C1}','\u{1D4F5}','\u{1D529}','\u{1D55D}','\u{1D591}','\u{1D5C5}','\u{1D5F9}','\u{1D62D}','\u{1D661}','\u{1D695}','\u{01C0}','\u{0399}','\u{1D6B0}','\u{1D6EA}','\u{1D724}','\u{1D75E}','\u{2C92}','\u{0406}','\u{05D5}','\u{05DF}','\u{0627}','\u{1EE00}','\u{FE8E}','\u{FE8D}','\u{07CA}','\u{2D4F}','\u{16C1}','\u{A4F2}','\u{1028A}','\u{10309}','\u{0142}','\u{026D}','\u{019A}','\u{026B}','\u{0625}','\u{FE88}','\u{FE87}','\u{0673}','\u{2488}','\u{0623}','\u{FE84}','\u{FE83}','\u{0672}','\u{0675}']);
    ...
    while input_chars.peek() != None {
        ...
        match next_confusables {
            Some(next_confusables) => {
                ...
                //TODO: delete after discrete character canonicalization
                output.push(next);
            }    
            None => {
                output.push(next);
