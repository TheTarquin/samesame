...
pub fn map(input: String) -> String {
    ...
    confusables.insert('S', vec!['\u{024}', '\u{FF33}','\u{1D412}','\u{1D446}','\u{1D47A}','\u{1D4AE}','\u{1D4E2}','\u{1D516}','\u{1D54A}','\u{1D57E}','\u{1D5B2}','\u{1D5E6}','\u{1D61A}','\u{1D64E}','\u{1D682}','\u{0405}','\u{054F}','\u{13D5}','\u{13DA}','\u{A4E2}','\u{10296}','\u{10420}']);
    ...
    confusables.insert('s', vec!['\u{024}', '\u{FF53}','\u{1D42C}','\u{1D460}','\u{1D494}','\u{1D4C8}','\u{1D4FC}','\u{1D530}','\u{1D564}','\u{1D598}','\u{1D5CC}','\u{1D600}','\u{1D634}','\u{1D668}','\u{1D69C}','\u{A731}','\u{01BD}','\u{0455}','\u{118C1}','\u{10448}','\u{0282}','\u{1D74}']);
